...
- `pnpm inspect:facecap` — Downloads the `facecap.glb` used by the app and prints the ranked list of mesh candidates under each eye node (useful for debugging auto-fit selection without opening the browser).
